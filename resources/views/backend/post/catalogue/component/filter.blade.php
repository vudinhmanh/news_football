<form action="{{ route('post.catalogue.index') }}">
  <div class="flex flex-col md:flex-row md:items-center justify-between space-y-4 md:space-y-0 mb-4">
    ...
    <div class="flex items-center space-x-4">
      ...
      <a href="{{ route('post.catalogue.create') }}" class="btn btn-danger flex items-center px-4 py-2 rounded-lg text-white !mb-0">
        <i class="fa fa-plus mr-2"></i> Thêm mới nhóm bài viết
      </a>
    </div>
  </div>
