<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        <div class="col-lg-4 col-md-6 mb-5">
            ...
            <p class="text-white font-weight-medium"><i class="fa fa-map-marker-alt mr-2"></i>Số 298 Đ. Cầu Diễn, Minh Khai, Bắc Từ Liêm, Hà Nội</p>
            <p class="text-white font-weight-medium"><i class="fa fa-phone-alt mr-2"></i>0395792304</p>
            <p class="text-white font-weight-medium"><i class="fa fa-envelope mr-2"></i>Manhmanhmanh289@gmail.com</p>
        </div>
        <div class="col-lg-4 col-md-6 mb-5">
